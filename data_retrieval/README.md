...
* -r: optional flag forces refresh of the given search
* -o output_dir: optional arg specifies an output directory for the resulting xml file (default is pubmed-analyzer/data)
* search_term: the term to search PubMed for using EDirect. This term can be any valid pubmed query: "glygen", '"Glycoproteins"[MeSH Terms]', 'glygen AND "Glycoproteins"[MeSH Terms]', etc.